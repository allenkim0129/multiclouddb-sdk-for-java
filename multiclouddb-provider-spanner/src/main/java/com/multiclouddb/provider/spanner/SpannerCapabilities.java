...
public final class SpannerCapabilities {
    ...
    public static final CapabilitySet CAPABILITIES = new CapabilitySet(List.of(
            ...
            Capability.CHANGE_FEED_POINT_IN_TIME_CAP.withNotes("StartPosition.atTime is supported via the TVF start_timestamp parameter (within the change-stream retention window)"),
