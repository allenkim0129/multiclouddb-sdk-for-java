...
- Declares `PARTIAL_UPDATE` supported and `PARTIAL_UPDATE_EXTENDED_PAYLOAD` unsupported because native request or resulting-item envelopes can bind before the common 408,576-byte limit.
