...
- `CosmosCapabilities` declares **`PATCH_PRESERVES_TTL` as unsupported**. Items carrying the SDK-managed `ttl` field are rejected atomically instead of having their expiry silently extended.
