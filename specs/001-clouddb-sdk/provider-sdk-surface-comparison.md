...
- Declare **PATCH + TTL interaction** separately. DynamoDB advertises `PATCH_PRESERVES_TTL` because its absolute expiry attribute is untouched; Cosmos does not and rejects SDK-managed TTL items rather than silently restarting their relative countdown.
