...
- Java 17 LTS (Eclipse Adoptium Temurin-17.0.10.7-hotspot) + Jackson 2.17.0, SLF4J 2.0.12, Azure Cosmos SDK 4.82.0, AWS SDK v2 2.34.0 (DynamoDB + DynamoDB Enhanced), Google Cloud Spanner 6.62.0 (001-clouddb-sdk)
...
- 001-clouddb-sdk: Added Java 17 LTS (Eclipse Adoptium Temurin-17.0.10.7-hotspot) + Jackson 2.17.0, SLF4J 2.0.12, Azure Cosmos SDK 4.82.0, AWS SDK v2 2.34.0 (DynamoDB + DynamoDB Enhanced), Google Cloud Spanner 6.62.0
