...
public final class ConformanceConfig {
    ...
    /**
     * Build a {@link MulticloudDbClientConfig} for the given provider using system
     * properties
     ...
     */
    public static MulticloudDbClientConfig forProvider(ProviderId provider) {
    ...
    private static MulticloudDbClientConfig cosmosConfig() {
    ...
    private static MulticloudDbClientConfig dynamoConfig() {
        return MulticloudDbClientConfig.builder()
    ...
    private static MulticloudDbClientConfig spannerConfig() {
        return MulticloudDbClientConfig.builder()
