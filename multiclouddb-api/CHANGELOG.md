...
- Well-known `PARTIAL_UPDATE` capability, declared by every provider. Cosmos DB and DynamoDB support it; Spanner explicitly declares it unsupported and is rejected by the core capability gate.
