 ...
 */
public final class MulticloudDbKey {
    ...
    private MulticloudDbKey(String partitionKey, String sortKey, Map<String, String> components) {
        if (partitionKey == null || partitionKey.isBlank()) {
            throw new IllegalArgumentException("MulticloudDbKey partitionKey must be non-empty");
        }
     ...
     * @return a new {@code MulticloudDbKey}
     * @throws IllegalArgumentException if {@code partitionKey} is null or blank
     */
    public static MulticloudDbKey of(String partitionKey) {
        return new MulticloudDbKey(partitionKey, null, null);
    }
     ...
     * @throws IllegalArgumentException if {@code partitionKey} is null or blank
     */
    public static MulticloudDbKey of(String partitionKey, String sortKey) {
        return new MulticloudDbKey(partitionKey, sortKey, null);
    }
    ...
    public static MulticloudDbKey of(String partitionKey, String sortKey,
        ...
        return new MulticloudDbKey(partitionKey, sortKey, components);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MulticloudDbKey that)) return false;
     ...
     *         {@code MulticloudDbKey{partitionKey=pk, sortKey=sk}}
     */
    @Override
    ...
    private static String buildString(String partitionKey, String sortKey,
            Map<String, String> components) {
        StringBuilder sb = new StringBuilder("MulticloudDbKey{partitionKey=").append(partitionKey);
