 ...
 */
public final class MulticloudDbError {

    private final MulticloudDbErrorCategory category;
    ...
    public MulticloudDbError(MulticloudDbErrorCategory category, String message, ProviderId provider,
    ...
    public MulticloudDbErrorCategory category() {
        return category;
    }
    ...
    public String toString() {
        return "MulticloudDbError{category=" + category + ", message=" + message
