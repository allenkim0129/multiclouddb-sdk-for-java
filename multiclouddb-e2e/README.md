...
| 4b | Patch two fields when `Capability.PATCH` is supported; otherwise skip | `client.patch(...)` |
| 4c | Verify patch when executed (asserts `price` and dynamic `onSale`) | `client.read(...)` |
